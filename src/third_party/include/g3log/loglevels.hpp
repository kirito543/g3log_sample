...
namespace g3 {
   ...
   static const int kSystemValue = 800;
   static const int kCustomValue = 900;
...
const LEVELS G3LOG_DEBUG{g3::kDebugValue, {"DEBUG"}},
   ...
   G3LOG_ERROR {g3::kErrorValue, {"E"}},
   G3LOG_SYSTEM {g3::kSystemValue, {"S"}},
   G3LOG_CUSTOM {g3::kCustomValue, {"C"}},
...
namespace g3 {
   ...
   namespace log_levels {
      ...
      void setSquirrelLogLevel(int level);
   ...
   bool squirrelLogLevel(int vlog_level);

   bool squirrelEvery(int vlog_level);
